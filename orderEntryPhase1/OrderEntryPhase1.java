...
public class OrderEntryPhase1 {
    ...
    public static void main(String[] args) {
        ...
        int quantityOrdered = promptInt(sc, "Enter quantity ordered (integer): ", 0);
    ...
    private static String promptAlphaNum(Scanner sc, String prompt) {
        while (true) {
    ...
    private static double promptDecimal(Scanner sc, String prompt, double minValue) {
        while (true) {
            ...
            try {
                ...
                System.out.println("Invalid entry. Please enter a decimal number (example 3.25).");
            }
        }
    }
